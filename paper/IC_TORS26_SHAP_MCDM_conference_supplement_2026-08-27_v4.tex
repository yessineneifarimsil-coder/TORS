% ============================================================
% Supplement to the concise conference-facing main manuscript
...
% Anonymous reviewer version: identifying repository metadata is withheld.
% ============================================================
...
\title{Supplementary Methods and Anonymous Audit Archive for\\
``Do Global XAI--MCDM Weights Add Decision Value?''}
...
The closed v1 state is anchored by an immutable version-control reference. Exact repository
identifiers and complete digests are withheld from this double-blind reviewer file; they are
available confidentially to editors and will accompany the public reproducibility archive after
review.
...
\toprule
\textbf{Main-paper element} & \textbf{Detailed supplementary evidence}\\
\midrule
Controlled ITS laboratory & Criterion definitions, capability pathways, copula contexts and
opportunity functions in Sect.~2.\\
Oracle and global attribution & Closed-form functional, joint-background moments, \XGB,
TreeSHAP and B100 checks in Sect.~3.\\
Structural correction & Calibration, positive control, numerical null and candidate screening
in Sect.~4.\\
D29 and Pilot-B evidence & World-resolved decision geometry, method contrasts and objective
weights in Sect.~5.\\
Observed selection maps & All audited modal identities, shares, unique-choice counts and
pairwise agreement summaries in Sect.~5.\\
Decision operators and gate & Exact weighting, tie, regret and hard-stop rules in Sects.~6--7.\\
Unexecuted primary plan & Clearly labelled archival protocols in Sects.~8--12.\\
...
\subsection{Frozen Post-Closure Fixed-Weight Selection-Map Diagnostic}
...
``alternative/share/$k$'', where $k=1$ denotes context-invariant selection in that world.
...
context-free oracle-modal choice estimated on WEIGHT and was optimal only for empirical oracle
Top-1 frequency among constant choices, not for minimizing regret. It was neither a deployable
competitor nor a universally optimal transportation policy. Direct-XGBoost was a parallel
...
\begin{table}[t]
\centering
\caption{Truncated reviewer-version content digests.}
...
Fixed-weight selection-map result & \texttt{a1f293b6...7e20f4e}\\
\bottomrule
\end{tabular}
\end{table}
...
Exact identifiers are intentionally omitted here to protect double-blind review. These facts
document software and artefact integrity; they are not statistical evidence.
