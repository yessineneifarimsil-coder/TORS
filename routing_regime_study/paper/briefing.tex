...
\textbf{Why is this not simply a demand classifier?} Because demand alone leaves a quarter of the value on the table. A depth-1 tree on demand captures $53.1\%$ of the headroom; adding the signal-regime split raises it to $79.9\%$. Signal regime carries $25.4\%$ of the fitted model's feature importance and is used in both branches. The restriction-location features are never used at all.
